...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/09 14:55:39 by asimone           #+#    #+#             */
/*   Updated: 2022/07/10 18:09:10 by asimone          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 2. Checks for the right top corner and returns C.
// 3. Checks for the left bottom corner and returns A.
// 4. Checks for the right bottom corner and returns C.
...
// Write a character based on the current position and user input.
//It adds a space if the current position is in the middle'
//It adds a A, C or a B if it is not in the middle.
...
//Display a rectangle on the screen based on user input.
